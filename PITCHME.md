...
- Examples
  - ShipCode = @css[text-green text-14](String) + @css[text-blue text-14]((∀ s => s.nonEmpty))
  - CompanyCode = @css[text-green text-14](String) + @css[text-blue text-14]((∀ s => """[a-z]{3}""".r matches s))
@ulend
@snapend
