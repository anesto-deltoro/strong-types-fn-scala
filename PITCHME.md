...
@snap[north-west]
#### Approach 1a: Value classes+smart constructors (5/9)
@snapend
...
@snap[north-west]
#### Approach 1a: Value classes+smart constructors (6/9)
@snapend
...
@snap[north-west]
#### Approach 1a: Value classes+smart constructors (7/9)
@snapend
...
@snap[north-west]
#### Approach 1b: Value classes+factory methods (8/9)
@snapend
...
@snap[north-west]
#### Approach 1b: Value classes+factory methods (9/9)
@snapend
